...
/*   Updated: 2017/03/23 17:03:24 by apouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

int		type(char c, t_val *a)
{
...
int		ft_flag(t_val *a, char *str, int i)
{
	i++;
	if ((str[i] >= '0' && str[i] <= '9'))
		i = nb(str, i, a, 1);
...
int		ft_type_nb(t_val *a, char *str, int i)
{
...
int		ft_tri_flag(t_val *a, va_list ap, char *str, int i)
{
	i = ft_flag(a, str, i);
